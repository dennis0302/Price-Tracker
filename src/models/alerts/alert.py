    ...
    def send(self):
        return requests.post(
            ...
            data={
                ...
                "text": "Hello, There is a deal that you might be interested in ({}). To navigate to the alert, visit {}".format(
                    self.item.url, "http://pricing.dhk.com/alerts/{}".format(self._id))
            }
        )
